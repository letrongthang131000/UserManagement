<%-- 
    Document   : updatePage
    Created on : Jun 11, 2021, 9:00:09 PM
    Author     : Thang
--%>
...
<html>
    ...
    <c:if test="${not empty sessionScope.USER}">
            <c:if test="${sessionScope.ADMIN}">
                <c:set var="dto" value="${sessionScope.UPDATEUSER}" />
                <div style="width: 100%">
                                        ...
                                        <div style="margin-left: 50px; margin-right: 50px;">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend shadow-sm">
                                                    <label class="input-group-text" for="roleUpdateSelect">Role</label>
                                                </div>
                                                <c:set var="roles" value="${sessionScope.ROLES}"/>
                                                <select class="custom-select shadow-sm" name="txtUpdateRole" id="roleUpdateSelect" style="width: 10%;">
                                                    <c:forEach var="roleDto" items="${roles}">
                                                        <option value="${roleDto.roleName}"
                                                                <c:if test="${dto.roleName eq roleDto.roleName}">
                                                                    selected
                                                                </c:if>
                                                                >
                                                            ${roleDto.roleName}
